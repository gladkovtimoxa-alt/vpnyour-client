...
import ru.vpnyour.app.protocol.BadConfigException
...
import ru.vpnyour.app.protocol.VpnException
import ru.vpnyour.app.protocol.VpnStartException
import ru.vpnyour.app.protocol.putStatus
import ru.vpnyour.app.util.LoadLibraryException
import ru.vpnyour.app.util.Log
import ru.vpnyour.app.util.Prefs
import ru.vpnyour.app.util.net.NetworkState
import ru.vpnyour.app.util.net.TrafficStats
import org.json.JSONException
import org.json.JSONObject

private const val TAG = "AmneziaVpnService"

const val ACTION_DISCONNECT = "ru.vpnyour.app.action.disconnect"
const val ACTION_CONNECT = "ru.vpnyour.app.action.connect"
