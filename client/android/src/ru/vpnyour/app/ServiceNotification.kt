...
import ru.vpnyour.app.util.net.TrafficStats.TrafficData

private const val TAG = "ServiceNotification"

private const val OLD_NOTIFICATION_CHANNEL_ID: String = "ru.vpnyour.app.notification"
private const val NOTIFICATION_CHANNEL_ID: String = "ru.vpnyour.app.notifications"
...
class ServiceNotification(private val context: Context) {
    ...
    fun buildNotification(serverName: String?, protocol: String?, state: ProtocolState): Notification {
        ...
        return notificationBuilder
            ...
            .setContentTitle((serverName ?: "Скрытая сеть") + (protocol?.let { " $it" } ?: ""))
